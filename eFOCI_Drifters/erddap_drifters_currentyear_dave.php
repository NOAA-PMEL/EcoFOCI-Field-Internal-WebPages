...
<script>
    ...
    var geojsonLayer = new L.geoJson.ajax('http://akutan.pmel.noaa.gov:8080/erddap/tabledap/2022_Argos_Drifters_NRT.geoJson?&time>=2022-01-01&orderByMean("trajectory_id%2Ctime/1days")', {  
