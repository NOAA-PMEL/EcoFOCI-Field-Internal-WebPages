  ...
  <div class="tabbable">
    <div class="tab-content">
      <div class="tab-pane active" id="AAAA">
        <p><?php last_operations_report('inst_sbe38','cal_sbe38','False'); ?></p>
      </div>
      <div class="tab-pane" id="AAAB">
        <p><?php last_operations_report('inst_sbe45','cal_sbe45','False'); ?></p>
      </div>
      <div class="tab-pane" id="AAAC">
        <p><?php last_operations_report('inst_sbe48','cal_sbe48','False'); ?></p>
      </div>
    </div>
  </div> <!-- /tabbable -->  
